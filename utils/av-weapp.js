        ...
        e.exports = function(e) {
            e.User = e.Object.extend("_User", {
                ...
                authenticated: function() {
                    return console.warn("DEPRECATED: 濡傛灉瑕佸垽鏂綋鍓嶇敤鎴风殑鐧诲綍鐘舵€佹槸鍚︽湁鏁堬紝璇蜂娇鐢� currentUser.isAuthenticated().then()锛屽鏋滆鍒ゆ柇璇ョ敤鎴锋槸鍚︽槸褰撳墠鐧诲綍鐢ㄦ埛锛岃浣跨敤 user.id === currentUser.id銆�"), 
